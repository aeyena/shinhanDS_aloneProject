...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="investorLogin.do" method="post">
				<img
				...
				<div class="input-div one">
					...
					<div class="div">
						<h5>Username</h5>
						<input type="text" class="input" name="investorID">
					</div>
				</div>
				<div class="input-div pass">
					...
					<div class="div">
						<h5>Password</h5>
						<input type="password" class="input" name="investorPW">
					</div>
				</div>
				<a href="investorJoin.do">회원가입</a> <input type="submit"
