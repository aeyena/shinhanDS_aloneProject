...
@WebServlet("/investor/investorFunding.do")
public class InvestorFundingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("investorFunding.jsp");
